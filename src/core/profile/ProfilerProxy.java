...
public class ProfilerProxy implements InvocationHandler
{
    ...
    public double getDoubleFromMap(Map<Method, Double> map, Method method)
    {
    ...
    public long getLongFromMap(Map<Method, Long> map, Method method)
    {
        if (map.get(method) == null)
            return 0;
            ...
            throws Throwable
    {
        ...
        double sum = getDoubleFromMap(sums, method);
        long counter = getLongFromMap(counters, method);
