...
public class ImagePallete
{
     ...
     * 
     * @param resource The xml resource to be loaded.
     */
    ...
    public void reload()
    {
        Document doc = loadDocument(getClass().getResourceAsStream(resource));
        ...
        for (ImageLoader loader : getLoaders())
        {
            ...
            {
                ImageItemList<ImageItem> list = loader.load((Element) elements.item(i));
     ...
     * 
     * @param name The name of both the image and the list.
     * @return The image.
     * @throws IllegalArgumentException If the image could not be found.
     */
     ...
     * 
     * @param listName The name of the list that contains the image.
     * @return The image.
     */
